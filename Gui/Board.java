...
//   private static Board  board1 = null;
        ...
        for (int i = 0; i < shapes.size(); i++) {
            if (shapes.get(i) instanceof Line) {
                ...
                if (c.getX1() < c.getX2() && c.getY1() < c.getY2()) {
                   ...
                   g.drawOval(c.getX1(), c.getY2(), Math.abs(c.getY1() - c.getY2()), Math.abs(c.getY1() - c.getY2()));
                } 
                else if (c.getX1() > c.getX2() && c.getY1() < c.getY2()) {
                    g.drawOval(c.getX2(), c.getY1(), Math.abs(c.getX2() - c.getX1()),Math.abs (c.getX2() - c.getX1()));
                } 
                else if ( c.getX1() > c.getX2() && c.getY1() > c.getY2()) {
                   g.drawOval(c.getX2(), c.getY2(), Math.abs(c.getX2() - c.getX1()), Math.abs(c.getX2()- c.getX2()));
                }
...
//                    z = new Rectangle(r.getX1() + 10, r.getY1() + 10, r.getX2() + 10, r.getY2() + 10, r.getColor());
//
//                    shapes.add(r);
//                    shapes.add(z);
//
...
//
//                    repaint();
try { Square B = (Square)f.creator(0, 0, 0, 0, current, 3)  ;
                B = (Square) selected;
                    Square s  = (Square) B.clone();
                    s.setX1(s.getX1()+10);s.setX2(s.getX2()+10); s.setY1(s.getY1()+10);s.setY2(s.getY2()+10);
                    shapes.add(s);
                    shapes.add(B);
                    repaint();
...
//                    shapes.add(d);
//                    repaint();
try { Circle q = (Circle)f.creator(0, 0, 0, 0, current, 1)  ;
                q = (Circle) selected;
                    Circle c  = (Circle) q.clone();
                    c.setX1(c.getX1()+10);c.setX2(c.getX2()+10); c.setY1(c.getY1()+10);c.setY2(c.getY2()+10);
                    shapes.add(c);
                    shapes.add(q);
                    repaint();
...
//                    shapes.add(m);
//                    repaint();
                    try { Line p = (Line)f.creator(0, 0, 0, 0, current, 0)  ;
                p = (Line) selected;
                    Line l  = (Line) p.clone();
                    l.setX1(l.getX1()+10);l.setX2(l.getX2()+10); l.setY1(l.getY1()+10);l.setY2(l.getY2()+10);
                    shapes.add(l);
                    shapes.add(p);
                    repaint();
...
//                    shapes.add(p);
//                    repaint();
                    try { Oval o = (Oval)f.creator(0, 0, 0, 0, current, 5)  ;
                o = (Oval) selected;
                    Oval d  = (Oval) o.clone();
                    d.setX1(d.getX1()+10);d.setX2(d.getX2()+10); d.setY1(d.getY1()+10);d.setY2(d.getY2()+10);
                    shapes.add(d);
                    shapes.add(o);
                    repaint();
